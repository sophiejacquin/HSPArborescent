...
#ifndef _eocascadeStat_h
#define _eocascadeStat_h
 ...
 */
template <class EOT>
class eocascadeStat : public eoStat<EOT, double>
{
public :
...
// START eventually add or modify the anyVariable argument
   ...
   */
  eocascadeStat(std::string _description = "eocascadeStat ") :
...
// END eventually add or modify the anyVariable argument
  ...
  virtual std::string className(void) const { return "eocascadeStat"; }
private :
// START Private data of an eocascadeStat object
  //  varType anyVariable;		   // for example ...
// END   Private data of an eocascadeStat object
};
